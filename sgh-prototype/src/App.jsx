...
import { Home, Search, Calendar, FileText, User, ClipboardList, Users, Pill, Activity, BarChart3, Building2, TrendingUp, ShieldCheck, FlaskConical, Settings } from "lucide-react";
...
export default function App() {
  ...
  return (
    <div className="f-body" style={{ minHeight: "100%", background: role ? "var(--mist)" : "transparent" }}>
      {!role && <Login accounts={accounts} onLogin={handleLogin} onRegister={handleRegister} />}
